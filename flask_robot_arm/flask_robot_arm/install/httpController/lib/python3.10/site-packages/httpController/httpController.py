...
class MoveItHttpController(Node):
    ...
    def get_greet_sequence(self, action_type: int) -> List[PoseRPY]:
        ...
        sequences = {
            ...
            2: self._greet_sequence_2(),  # 点头致意
            3: self._greet_sequence_3()   # 复杂问候
        }
    ...
    def _greet_sequence_1(self) -> List[PoseRPY]:
        ...
        # 起始位置（抬起手臂）
        poses.append(PoseRPY(x=0.2, y=0.2, z=0.4, roll=0.0, pitch=0.0, yaw=0.0))
        # 左摆
        poses.append(PoseRPY(x=0.2, y=0.3, z=0.4, roll=0.0, pitch=0.0, yaw=0.0))
        # 右摆
        poses.append(PoseRPY(x=0.2, y=0.1, z=0.4, roll=0.0, pitch=0.0, yaw=0.0))
        # 回到中心
        poses.append(PoseRPY(x=0.2, y=0.2, z=0.4, roll=0.0, pitch=0.0, yaw=0.0))
