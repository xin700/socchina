...
bool motor_msg__msg__motor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_msg.msg._motor.Motor", full_classname_dest, 26) == 0);
  }
  motor_msg__msg__Motor * ros_message = _ros_message;
  {  // id
  ...
  {  // sub_divide
    PyObject * field = PyObject_GetAttrString(_pymsg, "sub_divide");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->sub_divide = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * motor_msg__msg__motor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_msg.msg._motor");
  ...
  {  // sub_divide
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->sub_divide);
    {
      int rc = PyObject_SetAttrString(_pymessage, "sub_divide", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
